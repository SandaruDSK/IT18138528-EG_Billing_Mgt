	...
	public String readBills()
	 ...
	 if (con == null)
		 {	return "Error while connecting to the database for reading."; }
		 	...
		 	output = "<table border='1'><tr><th>Billing ID</th><th>Customer ID</th>" +
				  "<th>Customer Name</th>" +
				  "<th>Customer Email</th>" +
				  "<th>Customer Contact</th>" +
				  "<th>Used Points</th>" +
				  "<th>Amount for Used Points</th>" +
				  "<th>Additional Charge</th>" +
				  "<th>Previous Outstanding</th>" +
				  "<th>Total Amount to Pay</th>" +
				  "<th>Bill Type(Red or Normal) </th>" +
	 ...
	 while (rs.next())
	 {
		 ...
		 output += "<tr><td><input id='hidBilling_IDUpdate' name='hidBilling_IDUpdate' type='hidden' value='" + B_ID + "'>" + B_ID + "</td>";
		 ...
		 output += "<td><input name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-secondary'></td>" 
				 + "<td><input name='btnRemove' type='button' value='Remove' class='btnRemove btn btn-danger' data-billingid='"+ B_ID + "'>" + "</td></tr>";
	 }
	 con.close();
